...
@section('content')
    <h2 class="text-2xl font-semibold text-white mb-6">Tambah Pegawai Baru</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-200">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="alamat" name="alamat" rows="3"
                              class="w-full px-4 py-2 rounded-lg bg-white/10 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-accent-purple">{{ old('alamat') }}</textarea>
