...
@section('content')
    <div class="card-gradient max-w-2xl mx-auto p-8 rounded-2xl shadow-lg border border-white/10 text-gray-200">
        <h2 class="text-2xl font-semibold text-white mb-6">Formulir Jabatan</h2>
        ...
        <form action="{{ route('positions.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nama_jabatan" id="nama_jabatan"
                    ...
                    placeholder="cth: Manajer Proyek" value="{{ old('nama_jabatan') }}">
                @error('nama_jabatan')
            ...
            <div class="mb-6">
                ...
                <input type="number" name="gaji_pokok" id="gaji_pokok"
                    ...
                    placeholder="cth: 5000000" value="{{ old('gaji_pokok') }}">
                @error('gaji_pokok')
                    <p class="text-red-400 text-xs mt-2">{{ $message }}</p>
                @enderror
            </div>
